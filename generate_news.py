...
# CSO를 활용하는 제약사 — '통합 제약사 수수료리스트.xlsx' 실제 거래 목록 기준
CSO_PHARMA_COMPANIES = [
    "유유제약", "건일바이오팜", "경동제약", "경보제약", "광동제약",
    "구주제약", "국제약품", "다나젠", "다산제약", "대우제약",
    "대웅바이오", "대웅제약", "대원제약", "대한뉴팜", "대화제약",
    "동광제약", "동구바이오제약", "동국제약", "동성제약", "라이트팜텍",
    "마더스제약", "맥널티제약", "메디카코리아", "명문제약", "미래바이오제약",
    "바이넥스", "보령바이오파마", "비보존제약", "삼성제약", "삼익제약",
    "서울메디원", "서울제약", "셀트리온제약", "씨엠지제약", "CMG제약",
    "씨티씨바이오", "아이큐어", "아주약품", "안국뉴팜", "안국약품",
    "알리코제약", "에이치엘비제약", "HLB제약", "에이프로젠제약", "영일제약",
    "영진약품", "오스코리아", "오스틴제약", "옵투스제약", "위더스제약",
    "유영제약", "이든파마", "넥스팜코리아", "일성신약", "일화",
    "제뉴원사이언스", "제뉴파마", "제일약품", "진양제약", "케이엠에스",
    "크리스탈제약", "킴스제약", "테라젠이텍스", "파마사이언스", "파마킹",
    "팜젠사이언스", "한국글로벌제약", "한국바이오켐", "한국애보트", "한국유니온제약",
    "한국파마", "한국파비스제약", "한국프라임제약", "한국피엠지제약", "한국휴텍스제약",
    "한올바이오파마", "한풍제약", "한화제약", "화이트생명과학", "휴비스트제약",
    "휴온스메디케어", "휴온스제약",
    # 수수료 목록 외 — CSO 전환·철수 이슈 추적 대상
    "JW중외제약", "신풍제약", "일동제약",
]
